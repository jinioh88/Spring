...
public class SearchBaordController {
	private static final Logger logger = LoggerFactory.getLogger(SearchBaordController.class);
	...
	public String remove(@RequestParam("bno")int bno, SearchCriteria cri, RedirectAttributes rttr) throws Exception {
		...
		rttr.addAttribute("perPaegNum",cri.getPerPageNum());
